...
| Reviewer | Reviews a plan or a frozen diff with clean context. Runs the verifications. Never edits. | Short: one session per review subject |
| Chore | Procedural work: long verification runs, CI monitoring, log triage, rebases, mechanical edits. | As long as the chore |
